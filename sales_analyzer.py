...
class SalesAnalyzer:
    ...
    def most_expensive_product(self):
        expensive_item = self.df.loc[self.df['Price'].idxmax()]
        print(f"\n{expensive_item['Brand']} - {expensive_item['Model']} is most expensive product at ${expensive_item['Price']}.")
    ...
    def best_selling_product(self):
        top_selling_item = self.df.loc[self.df['Sales'].idxmax()]
        print(f"\n{top_selling_item['Brand']} - {top_selling_item['Model']} is the best-selling product with {top_selling_item['Sales']} units sold.")
